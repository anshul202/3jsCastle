  ...
  return (
    <section className="max-container ">
      <h1 className='head-text'>
        Hello! I am <span className='blue-gradient_text font-semibold drop-shadow'>Anshul</span>
      </h1>

      <div className='mt-5 flex flex-col gap-3 text-slate'>
        <p>For lack of a better description</p>
      </div>
        ...
        <div className='mt-16 flex flex-wrap gap-12'>
          {skills.map((skill)=>{
            <div className='block-container w-20 h-20'>
              ...
              <img src={skill.imageUrl} alt={skill.name} className='w-1/2 h-1/2 object-container'/>
              </div>
            </div>
